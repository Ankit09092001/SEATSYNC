...
export default function App(props) {
  ...
  function handleSleeper(){
    if(props.data.SleeperSeat === 0){
      ...
      navigate("/passengerform",{state : {props:props,Class: "sleeper" }})
    }
  }
  function handleAC(){
    if(props.data.ACSeat === 0){
      ...
      navigate("/passengerform",{state : {props:props,Class: "ac" }})
    }
  }
    ...
    <div>
      ...
      <MDBRow className='mb-'>
        <MDBCol md='4' className='mb-3'>
          <div className='p- text-uppercase fw-bold'>{props.source}<br /><p>{props.data.startTime}</p></div>
        </MDBCol>
        <MDBCol md='4' className='mb-3'>
          <div className='p- '>- - - -  {props.data.distance} KM  - - - -</div>
        </MDBCol>
        <MDBCol md='4' className='mb-3'>
          <div className='p- text-uppercase fw-bold'>{props.destination}<br /><p>{props.data.endTime}</p></div>
        </MDBCol>
      </MDBRow>
